...
QT_MOC_LITERAL(3, 22, 11), // "reportLogin"
QT_MOC_LITERAL(4, 34, 12), // "staffClicked"
QT_MOC_LITERAL(5, 47, 21), // "on_saleButton_clicked"
QT_MOC_LITERAL(6, 69, 26), // "on_inventoryButton_clicked"
QT_MOC_LITERAL(7, 96, 22), // "on_staffButton_clicked"
QT_MOC_LITERAL(8, 119, 23) // "on_reportButton_clicked"

    },
    "MenuWindow\0callLogin\0\0reportLogin\0"
...
void MenuWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MenuWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuWindow::reportLogin)) {
                *result = 1;
                return;
            }
        }
