...
DISTDIR = /home/neal/Desktop/QtProcess/.tmp/32bit_binary1.0.0
LINK          = g++
...
$(TARGET): ui_staffwindow.h ui_menuwindow.h ui_reportswindow.h ui_logindialog.h ui_transactionwindow.h ui_pinnumpad.h ui_inventorywindow.h ui_itemmodify.h ui_mainwindow.h $(OBJECTS)  
	...
	objcopy --only-keep-debug 32bit_binary 32bit_binary.debug && objcopy --strip-debug 32bit_binary && objcopy --add-gnu-debuglink=32bit_binary.debug 32bit_binary && chmod -x 32bit_binary.debug
...
distclean: clean 
	-$(DEL_FILE) $(TARGET) 
	-$(DEL_FILE) /home/neal/Desktop/QtProcess/32bit_binary.debug .qmake.stash
	-$(DEL_FILE) Makefile
...
ui_mainwindow.h: mainwindow.ui \
		../../Qt/5.7/gcc_64/bin/uic
	/home/neal/Qt/5.7/gcc_64/bin/uic mainwindow.ui -o ui_mainwindow.h
