...
SOURCES       = main.cpp \
		...
		reportswindow.cpp \
		logindialog.cpp \
		reportlistdialog.cpp qrc_resource.cpp \
		moc_onesolmain.cpp \
		moc_staffwindow.cpp \
		moc_menuwindow.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents onesolmain.h staffwindow.h dbmanager.h menuwindow.h reportswindow.h logindialog.h singleton.h reportlistdialog.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp onesolmain.cpp staffwindow.cpp dbmanager.cpp menuwindow.cpp reportswindow.cpp logindialog.cpp reportlistdialog.cpp $(DISTDIR)/
	$(COPY_FILE) --parents staffwindow.ui menuwindow.ui reportswindow.ui logindialog.ui reportlistdialog.ui $(DISTDIR)/
...
staffwindow.o: staffwindow.cpp staffwindow.h \
		...
		../../Qt/5.7/gcc_64/include/QtWidgets/qtextbrowser.h \
