...
#include "../newfolder/QtProcess/inventorywindow.h"
...
const QMetaObject InventoryWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_InventoryWindow.data,
      qt_meta_data_InventoryWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InventoryWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InventoryWindow.stringdata0))
        return static_cast<void*>(const_cast< InventoryWindow*>(this));
