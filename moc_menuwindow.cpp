...
QT_MOC_LITERAL(3, 22, 23) // "on_reportButton_clicked"

    },
    "MenuWindow\0callLogin\0\0on_reportButton_clicked"
};
...
void MenuWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_reportButton_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (MenuWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuWindow::on_reportButton_clicked)) {
                *result = 1;
                return;
            }
        }
